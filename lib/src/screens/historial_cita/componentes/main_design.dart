import 'package:cl_carmelo/src/screens/historial_cita/componentes/banner.dart';
import 'package:cl_carmelo/src/screens/historial_cita/componentes/contenedor.dart';
...
class MainDesignHistorialCita extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {
    final String apiURL = 'https://flutterclcarmelo.000webhostapp.com/ws/obtenerCitaInfo.php';
  ...
  Future<List<Cita>> fetchCita() async {
    ...
    if (response.statusCode == 200) {
      ...
      List<Cita> studentList = items.map<Cita>((json) {
